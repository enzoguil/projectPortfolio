...
<div id="centre" class="p-6">
    ...
    <div id="last_projects" class="flex flex-wrap justify-center gap-4">
        @foreach ($projects as $project)
            <a href="{{ route('projects.show', $project->id) }}" class="fiche_projet bg-gray-800 rounded-lg p-4 w-1/4 text-center transition duration-500 hover:shadow-lg" style="background-image: url('{{ asset($project->image) }}'); background-size: cover; background-position: center;">
